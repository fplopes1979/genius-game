...
const newColor = () => {
	...
	if(_data.score === 2) {
		alert("Você venceu! Parabéns! Use o cupom BFDDESCONTO10 e tenha 10% de desconto em qualquer produto do site!");
		alert("Se quiser jogar novamente, desligue e ligue o jogo e boa jogatina!");
		_data.gameOn = false;
		return;
	}
